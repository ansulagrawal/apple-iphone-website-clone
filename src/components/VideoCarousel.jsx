...
const VideoCarousel = () => {
  ...
  useGSAP(() => {
    ...
    gsap.to('#video', {
      ...
      onComplete: () => setVideo(pre => ({ ...pre, startPlay: true, isPlaying: true })),
    });
  }, [isEnd, videoId]);
  ...
  useEffect(() => {
    ...
    if (span[videoId]) {
      ...
      const animUpdate = () => anim.progress(videoRef.current[videoId].currentTime / hightlightsSlides[videoId].videoDuration);
  ...
  const handleLoadedMetaData = e => setLoadedData(pre => [...pre, e]);

  return (
    <>
      <div className="flex items-center">
        {hightlightsSlides.map(({ id, video: currentVideo, textLists }) => (
            ...
            <div className="video-carousel_container">
              <div className="w-full h-full flex-center rounded-3xl overflow-hidden bg-black">
                <video
                  ...
                  onEnded={() => (id !== 3 ? handleProcess('end', id) : handleProcess('last'))}
      ...
      <div className="relative flex-center mt-10">
        ...
        <button className="control-btn" onClick={isLastVideo ? () => handleProcess('reset') : !isPlaying ? () => handleProcess('play') : () => handleProcess('pause')}>
